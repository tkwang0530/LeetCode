...
You may assume that next() calls will always be valid. That is , there will be at least a next numbner in the in-order traversal when next() is called.
